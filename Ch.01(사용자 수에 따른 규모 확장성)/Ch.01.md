...
메시지 큐는 메시지의 무손실(Durability)을 보장하는, 비동기 통신(Asynchronous Communication)을 지원하는 컴포넌트다.
...
![image.png](./images/1-19.png)

## 데이터베이스의 규모 확장

![image.png](./images/1-20.png)
